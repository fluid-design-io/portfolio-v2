...
const VIDEO_CONSTANTS = {
  FPS: 24,
  FRAME_DURATION: 1 / 24 / 7.2,
  FOREGROUND_TIME: 7.8, // Time when foreground content appears
  TRANSITION_TIME: 7.8, // Time for route transition animations
  END_TIME: 15, // Final frame of the video
} as const;
